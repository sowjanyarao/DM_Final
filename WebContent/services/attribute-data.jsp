...
%>
					...
					<%= resourceBundle.getProperty("DataManager.DisplayText.Yes") %>
                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-9 col-md-offset-3">
                                    ...
                                    <button type="reset" class="btn btn-effect-ripple btn-danger" style="overflow: hidden; position: relative;">Delete Graph</button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="block full">
                        ...
                        <!--<div class="tab-content">
                            <div class="tab-pane" id="block-tabs-home"><input type="text" id="example-datepicker" name="example-datepicker" class="form-control input-datepicker" data-date-format="mm/dd/yy" placeholder="mm/dd/yy"></div>
                            <div class="tab-pane active" id="block-tabs-profile1">
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="example-file-input">Attachments<br>( upload files greater than 200kb)</label>
                            ...
                            <div class="tab-pane" id="block-tabs-profile2">
                                <div class="form-group">
