					...
					<%= resourceBundle.getProperty("DataManager.DisplayText.Yes") %>		
                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-9 col-md-offset-3">
                                	<input type="button" name="ViewComments" id="ViewComments" value="<%= resourceBundle.getProperty("DataManager.DisplayText.Show_Comments") %>" onClick="showComments()" class="btn btn-effect-ripple btn-primary"/>
                                </div>
                            </div>
