            ...
            <div id="main-container">
                ...
                <div id="page-content">
                    <div class="block">
                        ...
                        <form  method="post" class="form-horizontal form-bordered" action="showAttrDataGraph.jsp">
					...
					<%= resourceBundle.getProperty("DataManager.DisplayText.Yes") %>
                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-9 col-md-offset-3">
                                    <button type="submit" class="btn btn-effect-ripple btn-primary" style="overflow: hidden; position: relative;" onClick="showGraph()">Show Graph</button>
                                    <button type="reset" class="btn btn-effect-ripple btn-danger" style="overflow: hidden; position: relative;" onClick="deleteGraph()">Delete Graph</button>
                                </div>
                            </div>
                        </form>
