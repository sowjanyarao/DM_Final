...
%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                	<input type="text" size="10" id="start_date" name="start_date" class="form-control input-datepicker" data-date-format="mm/dd/yy" placeholder="mm/dd/yy">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-9 col-md-offset-3">
                                	<input type="button" lass="btn btn-effect-ripple btn-primary" name="search" value="<%= resourceBundle.getProperty("DataManager.DisplayText.Show_Graph") %>" onClick="showGraph()">
                                </div>
                            </div>
                        </form>
